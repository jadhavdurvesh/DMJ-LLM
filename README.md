...
*An open-source engineering-focused Large Language Model (LLM) designed for programming, robotics, embedded systems, electronics, and artificial intelligence.*
<p align="center">
...
![LoRA](https://img.shields.io/badge/Fine--Tuning-LoRA-8A2BE2?style=for-the-badge)
![PEFT](https://img.shields.io/badge/PEFT-Supported-success?style=for-the-badge)
...
flowchart TD
    ...
    A[📚 Engineering Dataset] --> B[🧹 Data Cleaning]
    B --> C[📦 Training Dataset]
    C --> D[🧠 Base Language Model]
    D --> E[⚡ Fine-Tuning]
    E --> F[🤖 DMJ LLM]
    F --> G[💬 User Chat]
```
